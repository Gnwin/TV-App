...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://tv-app/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://tv-app/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://tv-app/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://tv-app/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nclass Comment {\n  constructor (id, date, name, insight) {\n    this.id = id;\n    this.name = name;\n    this.date = date;\n    this.insight = insight;\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Comment);\n\n//# sourceURL=webpack://tv-app/./src/assets/js/modules/Comment.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _InvolvementAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./InvolvementAPI */ \"./src/assets/js/modules/InvolvementAPI.js\");\n/* harmony import */ var _InsertCommentContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./InsertCommentContent */ \"./src/assets/js/modules/InsertCommentContent.js\");\n/* harmony import */ var _CommentTemplate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CommentTemplate */ \"./src/assets/js/modules/CommentTemplate.js\");\n/* harmony import */ var _CommentModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CommentModal */ \"./src/assets/js/modules/CommentModal.js\");\n/* harmony import */ var _Comment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Comment */ \"./src/assets/js/modules/Comment.js\");\n/* harmony import */ var _CommentMarkup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CommentMarkup */ \"./src/assets/js/modules/CommentMarkup.js\");\n/* harmony import */ var _Date__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Date */ \"./src/assets/js/modules/Date.js\");\n\n\n\n\n\n\n\n\nclass GrabUserInput {\n  openComment = (e) => {\n    e.preventDefault();\n    const showId = e.target.parentElement.id;\n    const tvStorage = JSON.parse(localStorage.getItem('tvapp'));\n    let commentModal;\n    tvStorage.shows.forEach(element => {\n      if (showId == element.id) {\n        commentModal = new _CommentModal__WEBPACK_IMPORTED_MODULE_3__[\"default\"](element.id, element.name, element.image.medium);\n      }\n    });\n    const modal = document.getElementById(\"myModal\");\n    (0,_InsertCommentContent__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(commentModal, _CommentTemplate__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n      //   this.id = id;\n      //   this.name = name;\n      //   this.date = date;\n      //   this.insight = insight;\n      // }\n\n    const commentNum = document.querySelector('.commentnum');\n    if (tvStorage.comments.length === 0) {\n      commentNum.innerHTML = 0;\n    } else {\n      let existingComment = '';\n      const commentList = document.querySelector('.commentlist');\n      let counter = 0;\n      tvStorage.comments.forEach(element => {\n        if (showId == element.id) {\n          existingComment += (0,_CommentMarkup__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(element);\n          counter += 1;\n        }\n      })\n      commentList.innerHTML = existingComment;\n      commentNum.innerHTML = counter;\n    }\n    const makeAComment = document.querySelector('.comments1');\n    makeAComment.onclick = this.comment;\n    modal.style.display = \"block\";\n  }\n\n  closeComment = (e) => {\n    e.preventDefault();\n    const modal = document.getElementById(\"myModal\");\n    modal.style.display = \"none\";\n  }\n\n  like = (e) => {\n    e.preventDefault();\n    const itemid = e.target.parentElement.parentElement.id;\n    let likeElement = e.target.parentElement.parentElement.children[2].children[0].children[0];\n    let likenum = Number(likeElement.innerHTML);\n    likenum += 1;\n    likeElement.innerHTML = likenum;\n\n    const tvStorage = JSON.parse(localStorage.getItem('tvapp'));\n    tvStorage.likes.forEach(element => {\n      if (itemid == element.likeid) {\n        element.likes = likenum;\n      }\n    });\n    localStorage.setItem('tvapp', JSON.stringify(tvStorage));\n\n    // let appid = JSON.parse(localStorage.getItem('tvapp'));\n    // appid = appid.appId;\n    // console.log(appid);\n    // InvAPI.createlike(appid, itemid)\n    //   .then((response) => {\n    //     console.log(response);\n    //     return response;\n    //   })\n  }\n\n  comment = (e) => {\n    e.preventDefault();\n    const id  = e.target.parentElement.id;\n    const name = document.querySelector('.yourname');\n    const insight = document.querySelector('.yourinsight');\n    let namevalue = name.value;\n    let insightvalue = insight.value;\n    if (!namevalue || !insightvalue) {\n      return\n    }\n    name.value = '';\n    insight.value = '';\n    let date = (0,_Date__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(new Date());\n    const tvStorage = JSON.parse(localStorage.getItem('tvapp'));\n    const newlyCreatedComment = new _Comment__WEBPACK_IMPORTED_MODULE_4__[\"default\"](id, date, namevalue, insightvalue);\n\n    let newlyCreatedCommentMarkup =  (0,_CommentMarkup__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(newlyCreatedComment);\n    const commentList = document.querySelector('.commentlist');\n    let content = commentList.innerHTML;\n    content += newlyCreatedCommentMarkup;\n    commentList.innerHTML = content;\n    tvStorage.comments.push(newlyCreatedComment);\n    const commentNum = document.querySelector('.commentnum');\n    let counter = 0;\n    tvStorage.comments.forEach(element => {\n      if (id == element.id) {\n        counter += 1;\n      }\n    });\n    commentNum.innerHTML = counter;\n\n    localStorage.setItem('tvapp', JSON.stringify(tvStorage));\n  }\n}\n\nconst grabInput = new GrabUserInput()\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (grabInput);\n\n//# sourceURL=webpack://tv-app/./src/assets/js/modules/GrabUserinput.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nclass Like {\n  constructor(showid, likes) {\n    this.likeid = showid;\n    this.likes = likes;\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Like);\n\n//# sourceURL=webpack://tv-app/./src/assets/js/modules/Like.js?");
